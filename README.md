...
|------|-------------|----------|
| `GeminiVideoWatermarkRemover-Setup-1.2.4.exe` | Windows x64 Standalone Installer (NSIS) | Windows 10 / 11 (x64) |
...
1. Download `GeminiVideoWatermarkRemover-Setup-1.2.4.exe` from the [Releases](https://github.com/dinuwa2500/GeminiVideoWatermarkRemover/releases) page.
